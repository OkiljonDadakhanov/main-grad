    ...
    <section className="bg-gradient-to-b from-purple-700 to-purple-900 text-white py-16 md:py-24">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-10">
          ...
          <p className="text-md opacity-80 mt-2">Fill in all necessary information to add your university to our platform</p>
        </div>
            ...
            {step === 1 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input type="text" value={form.contact_person} onChange={(e) => handleChange("contact_person", e.target.value)} />
                </div>
                <div>
            ...
            {step === 2 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input type="text" value={form.classification} onChange={(e) => handleChange("classification", e.target.value)} />
                </div>
                <div>
                  <Label>Address</Label>
                ...
                <div>
                  ...
                  <Input type="text" value={form.zip_code} onChange={(e) => handleChange("zip_code", e.target.value)} />
                </div>
                <div>
            ...
            {step === 3 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input type="text" value={form.accreditation_number} onChange={(e) => handleChange("accreditation_number", e.target.value)} />
                </div>
                <div>
                  <Label>Upload Accreditation Document</Label>
                  <Input type="file" onChange={(e) => handleChange("accreditation_document", e.target.files[0])} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <Input type="text" value={form.translated_name} onChange={(e) => handleChange("translated_name", e.target.value)} />
                </div>
