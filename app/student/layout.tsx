  ...
  return (
    <div className="flex min-h-screen bg-gray-50/50 dark:bg-gray-950">
      ...
      <div className="flex-1 pl-64">
        {/* Top header */}
        <header className="flex items-center justify-between px-6 border-b bg-white dark:bg-gray-900 dark:border-gray-800 sticky top-0 z-20 shadow-sm dark:shadow-gray-950/50 h-16">
