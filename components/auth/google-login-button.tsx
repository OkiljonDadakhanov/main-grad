...
export function GoogleLoginButton({
  ...
  const triggerGoogleLogin = () => {
    ...
    const googleButton = containerRef.current?.querySelector('div[role="button"]') as HTMLElement;
    if (googleButton) {
      googleButton.click();
    }
  };
  ...
  return (
    <div className="relative">
      ...
      <div ref={containerRef} className="absolute opacity-0 pointer-events-none overflow-hidden h-0">
        <GoogleLogin
